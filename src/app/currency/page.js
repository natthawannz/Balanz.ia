    ...
    <main className="container mx-auto px-6 py-8" style={{ fontFamily: 'Noto Sans Thai, sans-serif' }}>
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">สกุลเงินต้นทาง</label>
            <select
              value={currencyFrom}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">สกุลเงินปลายทาง</label>
            <select
              value={currencyTo}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">จำนวนเงินที่แปลงแล้ว</label>
            <input
              type="text"
